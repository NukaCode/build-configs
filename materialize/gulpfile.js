...
elixir(function (mix) {
    mix.sass('app.scss', 'resources/css/')
        ...
        .copy(bower_dir + 'materialize/dist/js/materialize.js', 'resources/js/vendor/materialize.js')
        .scripts(
        [
            'resources/js/vendor/jquery.js',
            'resources/js/vendor/materialize.js',
        ], 'public/js/all.js')
        ...
        .copy(bower_dir + 'materialize/font', 'public/font')
